 ...
 * connection.
 * 指定HTTP流量经过的套接字连接的配置。
 * 对于https：// URL，这包括协商安全连接时使用的TLS版本和密码套件。
 * <p>
 ...
 * 只有在SSL套接字中启用了连接规范中配置的TLS版本才能使用。
 * 例如，如果SSL套接字没有启用TLS 1.3，即使它存在于连接规范中也不会被使用。 同样的政策也适用于密码套件。
 * <p>
 * <p>Use {@link Builder#allEnabledTlsVersions()} and {@link Builder#allEnabledCipherSuites} to
 * defer all feature selection to the underlying SSL socket.
 * 使用{@link Builder＃allEnabledTlsVersions（）}和{@link Builder＃allEnabledCipherSuites}将所有功能选择推迟到底层SSL套接字。
 */
