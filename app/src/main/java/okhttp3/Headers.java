 ...
 * <p>
 * *单个HTTP消息的头部字段。 值是未解释的字符串; 对解释的标题使用“请求”和“响应”。
 * 该类维护HTTP消息中头部字段的顺序。
 * <p>
